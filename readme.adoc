...
a|
* Use minideb Debian-13 trixie as base OS
* Not using set-output for GH actions
...
a|
* Use node20 Debian-11 as build image, use node20 Debian-13 (trixie) as running image
...
a|
* Use rockylinux/10-minimal as base OS
