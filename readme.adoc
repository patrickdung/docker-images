...
a|
* Use rockylinux minimal as base OS
...
|https://gitlab.com/patrick.dung/docker-images/container_registry/8351843[GitLab.com Container Registry, ARM64 only]
|Yes
a|
...
* https://gitlab.com/patrick.dung/docker-images/container_registry/8351928[My GitLab.com container registry, for ARM64]
|No
